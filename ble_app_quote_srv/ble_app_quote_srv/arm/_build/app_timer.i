...
static void timeout_handler_exec(timer_node_t * p_timer)
{
    if (m_evt_schedule_func != 0)
    {
        ...
        do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 340, (uint8_t*) "..\\..\\..\\..\\..\\Source\\app_common\\app_timer.c"); } while (0); } } while (0);
    }
    else
    {
