...
uint8_t _lis331dlh_read_id(void); 
																	

uint8_t _lis331dlh_read_status_reg(void); 
																					
																					
_Bool _lis331dlh_set_INT1_THS(uint8_t value);

_Bool _lis331dlh_set_INT1_DURATION(uint8_t value);


_Bool _lis331dlh_set_INT1_CFG(uint8_t value);

uint8_t _lis331dlh_get_INT1_SOURCE(void);

uint8_t _lis331dlh_set_cntrl_reg1(uint8_t value[]);		
uint8_t _lis331dlh_set_cntrl_reg2(uint8_t value[]);
uint8_t _lis331dlh_set_cntrl_reg3(uint8_t value[]);
uint8_t _lis331dlh_set_cntrl_reg4(uint8_t value[]);
uint8_t _lis331dlh_set_cntrl_reg5(uint8_t value[]);

_Bool	_lis331dlh_get_HP_FILTER_RESET(void);

uint8_t _lis331dlh_set_contrl_regs(uint8_t value[]);


uint8_t _lis331dlh_out_x_l(uint16_t * );


uint8_t _lis331dlh_out_x_h(uint16_t *out_x_h_r);


uint8_t _lis331dlh_out_y_l(uint16_t * );


uint8_t _lis331dlh_out_y_h(uint16_t *out_y_h_r);



uint8_t _lis331dlh_out_z_l(uint16_t * );


uint8_t _lis331dlh_out_z_h(uint16_t *out_z_h_r);


uint16_t store_accel_analyze(uint16_t);

_Bool check_for_neg(uint16_t accel_x);


uint16_t two_compl(uint16_t accel_x);



uint16_t dynamic_threshold(uint16_t accel_data[]);


void find_max_and_min(uint16_t* , uint16_t* , uint16_t []);
...
uint16_t store_accel_analyze(uint16_t acceleration)
{
	static uint16_t accel_data[50] = {0};
  static uint8_t data = 0;
	accel_data[data++] = acceleration;
	
  if(samples == 50 )
	{
		if(dynamic_threshold(accel_data))
		{
			nrf_gpio_pin_set(18);
		}
	}
...
uint16_t dynamic_threshold(uint16_t accel_data[])
{
	...
	find_max_and_min(&max, &min, accel_data);
...
void find_max_and_min(uint16_t *max, uint16_t *min , uint16_t accel_data[])
{
	uint8_t i = 0;
	if (accel_data[0] > accel_data[1])  
  {
      *max = accel_data[0];
      *min = accel_data[1];
  }  
...
uint8_t _lis331dlh_read_id(void)
{
	...
	uint8_t data1 = 0;
	 ...
	 if(twi_master_init())
		{
			if(twi_master_transfer(0x18 << 1, &data, 1, 1))
			{
				
				if(twi_master_transfer(0x18 << 1 | 0x01, &data1, 1, 1))
				{
...
uint8_t _lis331dlh_set_cntrl_reg1(uint8_t value[])
{
	if(twi_master_transfer(0x18 << 1, value, 2, 1))
	{
		return 1;
	}
	return 0;
...
uint8_t _lis331dlh_set_contrl_regs(uint8_t value[])
{
	if(twi_master_transfer(0x18 << 1, value, 6, 1))
	{
		return 1;
	}
		return 0;
...
uint8_t _lis331dlh_out_x_l(uint16_t *out_x_l_r)
{
	uint8_t out_x_l_t = 0xA8;
	uint8_t out_x_l_rr = 0;
	
	if(twi_master_transfer(0x18 << 1, &out_x_l_t, 1, 1))
		{
			nrf_delay_us(400);
			if(twi_master_transfer(0x18 << 1 | 0x01 , &out_x_l_rr, 1, 1))
			{
				  *out_x_l_r = out_x_l_rr;
					return 1;
			}
		}
		return 0;
...
uint8_t _lis331dlh_out_x_h(uint16_t *out_x_h_r)
{
	uint8_t out_x_h_t = 0x29;
	uint8_t out_x_h_rr = 0;
	
	if(twi_master_transfer(0x18 << 1, &out_x_h_t, 1, 1))
		{
			nrf_delay_us(400);
			if(twi_master_transfer(0x18 << 1 | 0x01 , &out_x_h_rr, 1, 1))
			{
				 *out_x_h_r = out_x_h_rr;
					return 1;
			}
		}
		return 0;
...
uint8_t _lis331dlh_out_y_l(uint16_t *out_y_l_r)
{
	uint8_t out_y_l_t = 0x2A;
	uint8_t out_y_l_rr = 0;
	
	if(twi_master_transfer(0x18 << 1, &out_y_l_t, 1, 1))
		{
			nrf_delay_us(400);
			if(twi_master_transfer(0x18 << 1 | 0x01 , &out_y_l_rr, 1, 1))
			{
				*out_y_l_r = out_y_l_rr;
					return 1;
			}
		}
		return 0;
...
uint8_t _lis331dlh_out_y_h(uint16_t *out_y_h_r)
{
	uint8_t out_y_h_t = 0x2B;
	uint8_t out_y_h_rr = 0;
	
	if(twi_master_transfer(0x18 << 1, &out_y_h_t, 1, 1))
		{
			nrf_delay_us(400);
			if(twi_master_transfer(0x18 << 1 | 0x01 , &out_y_h_rr, 1, 1))
			{
				 *out_y_h_r = out_y_h_rr;
					return 1;
			}
		}
		return 0;
...
uint8_t _lis331dlh_out_z_l(uint16_t *out_z_l_r)
{
	uint8_t out_z_l_t = 0x2C;
	uint8_t out_z_l_rr = 0;
	
	if(twi_master_transfer(0x18 << 1, &out_z_l_t, 1, 1))
		{
			nrf_delay_us(400);
			if(twi_master_transfer(0x18 << 1 | 0x01 , &out_z_l_rr, 1, 1))
			{
				  *out_z_l_r = out_z_l_rr;
					return 1;
			}
		}
		return 0;
...
uint8_t _lis331dlh_out_z_h(uint16_t *out_z_h_r)
{
	uint8_t out_z_h_t = 0x2D;
	uint8_t out_z_h_rr = 0;
	
	if(twi_master_transfer(0x18 << 1, &out_z_h_t, 1, 1))
		{
			nrf_delay_us(400);
			if(twi_master_transfer(0x18 << 1 | 0x01 , &out_z_h_rr, 1, 1))
			{
				*out_z_h_r = out_z_h_rr;
					return 1;
			}
		}
		return 0;
...
uint8_t _lis331dlh_read_status_reg(void)
{
	...
	uint8_t status_rec = 0;
	
	if(twi_master_transfer(0x18 << 1, &status_reg, 1, 1))
		{
				nrf_delay_us(400);
				if(twi_master_transfer(0x18 << 1 | 0x01 , &status_rec, 1, 1))
				{
					return status_rec;
				}
		}
...
_Bool _lis331dlh_set_INT1_THS(uint8_t value)
{
	uint8_t send_data[] = { 0x32, 0};
	send_data[1] = value;
	if(twi_master_transfer(0x18 << 1, send_data, 1, 1))
	{
		return 1;
	}
...
uint8_t _lis331dlh_get_INT1_SOURCE(void)
{
	uint8_t hp_filter_reg = 0x31;
	uint8_t status_rec = 0;
	
	if(twi_master_transfer(0x18 << 1, &hp_filter_reg, 1, 1))
		{
