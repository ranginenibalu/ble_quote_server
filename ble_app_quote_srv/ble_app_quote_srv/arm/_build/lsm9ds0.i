...
_Bool _lsm9ds0_set_control_registers(uint8_t []);
...
_Bool _lsm9ds0_activate_accelerometer(uint8_t []);
...
_Bool _lsm9ds0_activate_gyroscope(uint8_t []);
...
void _lsm9ds0_out_x_l_a(uint16_t *);
...
void _lsm9ds0_out_x_h_a(uint16_t *);
...
void _lsm9ds0_out_y_l_a(uint16_t *);
...
void _lsm9ds0_out_y_h_a(uint16_t *);
...
void _lsm9ds0_out_z_l_a(uint16_t *);
...
void _lsm9ds0_out_z_h_a(uint16_t *);
...
void _lsm9ds0_out_x_l_g(uint16_t *);
...
void _lsm9ds0_out_x_h_g(uint16_t *);
...
void _lsm9ds0_out_y_l_g(uint16_t *);
...
void _lsm9ds0_out_y_h_g(uint16_t *);
...
void _lsm9ds0_out_z_l_g(uint16_t *);
...
void _lsm9ds0_out_z_h_g(uint16_t *);
...
void _lsm9ds0_out_x_l_m(uint16_t *);
...
void _lsm9ds0_out_x_h_m(uint16_t *);
...
void _lsm9ds0_out_y_l_m(uint16_t *);
...
void _lsm9ds0_out_y_h_m(uint16_t *);
...
void _lsm9ds0_out_z_l_m(uint16_t *);
...
void _lsm9ds0_out_z_h_m(uint16_t *);
...
uint8_t _lsm9ds0_read_id(void)
{
	  uint8_t data = 0X0F, data1 = 0;
	  if(twi_master_transfer(0X3C, &data, 1, 1))
		 	{
				nrf_delay_us(400);
				if(twi_master_transfer(0X3C | 0x01, &data1, 1, 1))
				{
				  return data1;
				}
			}
...
_Bool _lsm9ds0_set_control_registers(uint8_t ctrl_regs[])
{
	if(twi_master_transfer(0X3C, ctrl_regs, 6, 1))
	{
		return 1;
	}
		return 0;
...
_Bool _lsm9ds0_activate_accelerometer(uint8_t config_regs_accel[])
{
	nrf_gpio_pin_set(23);
	nrf_gpio_pin_clear(28);
	nrf_gpio_pin_clear(22);
	nrf_gpio_pin_clear(30);
	if(twi_master_transfer(0X3C, config_regs_accel, 9, 1))
	{
		return 1;
	}
		return 0;
...
_Bool _lsm9ds0_activate_gyroscope(uint8_t config_regs_gyro[])
{
	 if(twi_master_transfer(0XD4, config_regs_gyro, 6, 1))
	{
		return 1;
	}
		return 0;
...
void _lsm9ds0_out_x_l_a(uint16_t *out_x_l_a)
{
	uint8_t x_l_add = 0x28;
	uint8_t x_l_ret = 0;
	
	if(x_l_ret = twi_master_transfer(0X3C, &x_l_add, 1, 1))
		{
			if(twi_master_transfer(0X3C | 0x01 , &x_l_ret, 1, 1))
			{
				  *out_x_l_a = x_l_ret;
			}
		}
...
void _lsm9ds0_out_x_h_a(uint16_t *out_x_h_a)
{
	uint8_t x_h_add = 0X29;
	uint8_t x_h_ret = 0;
	
	if(twi_master_transfer(0X3C, &x_h_add, 1, 1))
		{
			if(twi_master_transfer(0X3C | 0x01 , &x_h_ret, 1, 1))
			{
				  *out_x_h_a = x_h_ret;
			}
		}
...
void _lsm9ds0_out_y_l_a(uint16_t *out_y_l_a)
{
	uint8_t y_l_add = 0X2A;
	uint8_t y_l_ret = 0;
	
	if(twi_master_transfer(0X3C, &y_l_add, 1, 1))
		{
			if(twi_master_transfer(0X3C | 0x01 , &y_l_ret, 1, 1))
			{
				  *out_y_l_a = y_l_ret;
			}
		}
...
void _lsm9ds0_out_y_h_a(uint16_t *out_y_h_a)
{
	uint8_t y_h_add = 0X2B;
	uint8_t y_h_ret = 0;
	
	if(twi_master_transfer(0X3C, &y_h_add, 1, 1))
		{
			if(twi_master_transfer(0X3C | 0x01 , &y_h_ret, 1, 1))
			{
				  *out_y_h_a = y_h_ret;
			}
		}
...
void _lsm9ds0_out_z_l_a(uint16_t *out_z_l_a)
{
	uint8_t z_l_add = 0X2C;
	uint8_t z_l_ret = 0;
	
	if(twi_master_transfer(0X3C, &z_l_add, 1, 1))
		{
			if(twi_master_transfer(0X3C | 0x01 , &z_l_ret, 1, 1))
			{
				  *out_z_l_a = z_l_ret;
			}
		}
...
void _lsm9ds0_out_z_h_a(uint16_t *out_z_h_a)
{
	uint8_t z_h_add = 0X2D;
	uint8_t z_h_ret = 0;
	
	if(twi_master_transfer(0X3C, &z_h_add, 1, 1))
		{
			if(twi_master_transfer(0X3C | 0x01 , &z_h_ret, 1, 1))
			{
				  *out_z_h_a = z_h_ret;
			}
		}
...
void _lsm9ds0_out_x_l_m(uint16_t *out_x_l_m)
{
	uint8_t x_l_add = 0X08;
	uint8_t x_l_ret = 0;
	
	if(twi_master_transfer(0X3C, &x_l_add, 1, 1))
		{
			if(twi_master_transfer(0X3C | 0x01 , &x_l_ret, 1, 1))
			{
				  *out_x_l_m = x_l_ret;
...
void _lsm9ds0_out_x_h_m(uint16_t *out_x_h_m)
{
	uint8_t x_h_add = 0X09;
	uint8_t x_h_ret = 0;
...
void _lsm9ds0_out_y_l_m(uint16_t *out_y_l_m)
{
	uint8_t y_l_add = 0X0A;
	uint8_t y_l_ret = 0;
...
void _lsm9ds0_out_y_h_m(uint16_t *out_y_h_m)
{
	uint8_t y_h_add = 0X0B;
	uint8_t y_h_ret = 0;
...
void _lsm9ds0_out_z_l_m(uint16_t *out_z_l_m)
{
	uint8_t z_l_add = 0X0C;
	uint8_t z_l_ret = 0;
...
void _lsm9ds0_out_z_h_m(uint16_t *out_z_h_m)
{
	uint8_t z_h_add = 0X0D;
	uint8_t z_h_ret = 0;
...
void _lsm9ds0_out_x_l_g(uint16_t *out_x_l_g)
{
	uint8_t x_l_add = 0X28;
	uint8_t x_l_ret = 0;
	
	if(twi_master_transfer(0XD4, &x_l_add, 1, 1))
		{
			if(twi_master_transfer(0XD4 | 0x01 , &x_l_ret, 1, 1))
			{
				  *out_x_l_g = x_l_ret;
			}
		}		
...
void _lsm9ds0_out_x_h_g(uint16_t *out_x_h_g)
{
	uint8_t x_h_add = 0X29;
	uint8_t x_h_ret = 0;
	
	if(twi_master_transfer(0XD4, &x_h_add, 1, 1))
		{
			if(twi_master_transfer(0XD4 | 0x01 , &x_h_ret, 1, 1))
			{
				  *out_x_h_g = x_h_ret;
			}
		}
...
void _lsm9ds0_out_y_l_g(uint16_t *out_y_l_g)
{
	uint8_t y_l_add = 0X2A;
	uint8_t y_l_ret = 0;
	
	if(twi_master_transfer(0XD4, &y_l_add, 1, 1))
		{
			if(twi_master_transfer(0XD4 | 0x01 , &y_l_ret, 1, 1))
			{
				  *out_y_l_g = y_l_ret;
			}
		}
...
void _lsm9ds0_out_y_h_g(uint16_t *out_y_h_g)
{
	uint8_t y_h_add = 0X2B;
	uint8_t y_h_ret = 0;
	
	if(twi_master_transfer(0XD4, &y_h_add, 1, 1))
		{
			if(twi_master_transfer(0XD4 | 0x01 , &y_h_ret, 1, 1))
			{
				  *out_y_h_g = y_h_ret;
			}
		}
...
void _lsm9ds0_out_z_l_g(uint16_t *out_z_l_g)
{
	uint8_t z_l_add = 0X2C;
	uint8_t z_l_ret = 0;
	
	if(twi_master_transfer(0XD4, &z_l_add, 1, 1))
		{
			if(twi_master_transfer(0XD4 | 0x01 , &z_l_ret, 1, 1))
			{
				  *out_z_l_g = z_l_ret;
			}
		}
...
void _lsm9ds0_out_z_h_g(uint16_t *out_z_h_g)
{
	uint8_t z_h_add = 0X2D;
	uint8_t z_h_ret = 0;
	
	if(twi_master_transfer(0XD4, &z_h_add, 1, 1))
		{
			if(twi_master_transfer(0XD4 | 0x01 , &z_h_ret, 1, 1))
			{
				  *out_z_h_g = z_h_ret;
			}
		}
