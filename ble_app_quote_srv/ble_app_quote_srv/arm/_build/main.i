...
#line 368 "..\\..\\..\\..\\..\\Include\\app_common\\pstorage.h"
...
void app_error_handler(uint32_t error_code, uint32_t line_num, const uint8_t * p_file_name)
{
	...
	static uint8_t file_name[100] = {0}, i =0;
...
static void timers_init(void)
{
    ...
    do { static uint32_t APP_TIMER_BUF[((((( (((6)) * 40) + ( 3 * (8 + (((10) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (6), (10) + 1, APP_TIMER_BUF, (0) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 206, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
...
static void gap_params_init(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 249, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void advertising_init(void)
{
    ...
    ble_uuid_t adv_uuids[] = {{0x1522, 0x01}};
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 278, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void services_init(void)
{
	  ...
	  uint32_t err_code;
		ble_quote_init_t init;
		init.write_read_handler = write_read_handler;
	  init.erase_handler = erase_handler;
	  err_code = ble_quote_init(&m_inert, &init);
...
{
    do { app_error_handler((nrf_error), 362, (uint8_t*) "..\\main.c"); } while (0);
}
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_SEC_INFO_REQUEST:
            ...
            else
            {
                ...
                do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 496, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
            }
            break;
...
static void ble_evt_dispatch(ble_evt_t * p_ble_evt)
{
    ...
    ble_conn_params_on_ble_evt(p_ble_evt);
	  ...
	  ble_quote_on_ble_evt(&m_inert, p_ble_evt);
}
...
static void ble_stack_init(void)
{
    ...
    do { static uint32_t EVT_BUFFER[(((((((((sizeof(ble_evt_t) + (23))) < (0) ? (0) : ((sizeof(ble_evt_t) + (23))))) < (sizeof(uint32_t)) ? (sizeof(uint32_t)) : ((((sizeof(ble_evt_t) + (23))) < (0) ? (0) : ((sizeof(ble_evt_t) + (23))))))) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE; ERR_CODE = softdevice_handler_init((NRF_CLOCK_LFCLKSRC_XTAL_20_PPM), EVT_BUFFER, sizeof(EVT_BUFFER), (0) ? softdevice_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 565, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);

    
    err_code = softdevice_ble_evt_handler_set(ble_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 569, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
    
    
    err_code = softdevice_sys_evt_handler_set(sys_evt_dispatch);
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 573, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
{
    do { static uint32_t APP_SCHED_BUF[((((((((sizeof(app_timer_event_t))) + 8) * (((10)) + 1))) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_sched_init((sizeof(app_timer_event_t)), (10), APP_SCHED_BUF); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 581, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
{
    do { static uint32_t app_gpiote_buf[((((((1) * 20)) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_gpiote_init((1), app_gpiote_buf); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 614, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
static void buttons_init(void)
{
    ...
    do { uint32_t ERR_CODE = app_button_init((buttons), (sizeof(buttons) / sizeof(buttons[0])), (((uint32_t)((((50) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000)))), (0) ? app_button_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 631, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
...
static void power_manage(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 644, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
