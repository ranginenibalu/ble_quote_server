...
#line 7 "..\\ble_quote_srv.c"
#line 8 "..\\ble_quote_srv.c"
#line 9 "..\\ble_quote_srv.c"
...
#line 11 "..\\ble_quote_srv.c"

#line 13 "..\\ble_quote_srv.c"
...
uint32_t ble_quote_init(ble_quote_t * p_quote, const ble_quote_init_t * p_quote_init)
{
    ...
    err_code = sd_ble_gatts_service_add(0x01, &ble_uuid, &p_quote->service_handle);
    if (err_code != ((0x0) + 0))
    {
        return err_code;
    }
